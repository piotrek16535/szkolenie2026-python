...
for prog, pomiar in zip(prognoza,pomiary):
    ...
    #albo
    #_, _, temp_C_r, cisnienie_hPa_r, wilgotnosc_r = pomiar    / _, -kosz
    ...
    if o_temp<=1 and o_cisn<=2 and o_wilg<+10:
        ocena="dobra"
    ...
    wiersz=[  data_p, lotnisko_p,temp_C_p,temp_C_r,o_temp,
                  cisnienie_hPa_p, cisnienie_hPa_r,o_cisn,
                  wilgotnosc_p,wilgotnosc_r,o_wilg,ocena   ]
...
komentarz=f"PROGNOZY:\n" \
          ...
          f"Najwięcej złych ma lotnisko: {lotnisko_najgorsze}={min_dobrych} \n"
